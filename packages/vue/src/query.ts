/**
 * TanStack Query composables for @urauth/vue.
 *
 * Requires @tanstack/vue-query as a peer dependency.
 */

import { useQuery, useMutation, useQueryClient } from "@tanstack/vue-query";
import type { UseQueryReturnType } from "@tanstack/vue-query";
import type { AuthContext, UrAuthClient } from "@urauth/ts";
 ...
 */
export function useSession(client: UrAuthClient): UseQueryReturnType<AuthContext, Error> {
...
export function useLogin(client: UrAuthClient) {
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
export function useLogout(client: UrAuthClient) {
  const queryClient = useQueryClient();
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
export function useLogoutAll(client: UrAuthClient) {
  const queryClient = useQueryClient();
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
export function useRefresh(client: UrAuthClient) {
  const queryClient = useQueryClient();
