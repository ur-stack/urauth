declare global {
  ...
  const _useStoredSession: typeof import('../../../../packages/nuxt/src/runtime/server/utils/session')._useStoredSession
  ...
  const clearUserSession: typeof import('../../../../packages/nuxt/src/runtime/server/utils/session').clearUserSession
  ...
  const fetchBackend: typeof import('../../../../packages/nuxt/src/runtime/server/utils/fetch-backend').fetchBackend
  ...
  const getUserSession: typeof import('../../../../packages/nuxt/src/runtime/server/utils/session').getUserSession
  const getValidatedQuery: typeof import('../../node_modules/h3').getValidatedQuery
  const getValidatedRouterParams: typeof import('../../node_modules/h3').getValidatedRouterParams
  const handleCacheHeaders: typeof import('../../node_modules/h3').handleCacheHeaders
  const handleCors: typeof import('../../node_modules/h3').handleCors
  const hasPermission: typeof import('../../../../packages/nuxt/src/runtime/server/utils/authz').hasPermission
  const hasRole: typeof import('../../../../packages/nuxt/src/runtime/server/utils/authz').hasRole
  ...
  const refreshSession: typeof import('../../../../packages/nuxt/src/runtime/server/utils/fetch-backend').refreshSession
  const removeResponseHeader: typeof import('../../node_modules/h3').removeResponseHeader
  const requireUserPermission: typeof import('../../../../packages/nuxt/src/runtime/server/utils/authz').requireUserPermission
  const requireUserSession: typeof import('../../../../packages/nuxt/src/runtime/server/utils/session').requireUserSession
  ...
  const sessionHooks: typeof import('../../../../packages/nuxt/src/runtime/server/utils/session').sessionHooks
  ...
  const setUserSession: typeof import('../../../../packages/nuxt/src/runtime/server/utils/session').setUserSession
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/grandmagus/Documents/Projects/fastapi-pkgs/urauth/examples/task-manager-nuxt-frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/grandmagus/Documents/Projects/fastapi-pkgs/urauth/examples/task-manager-nuxt-frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hasPermission, hasRole, requireUserPermission } from '/Users/grandmagus/Documents/Projects/fastapi-pkgs/urauth/packages/nuxt/src/runtime/server/utils/authz';
export { fetchBackend, refreshSession } from '/Users/grandmagus/Documents/Projects/fastapi-pkgs/urauth/packages/nuxt/src/runtime/server/utils/fetch-backend';
export { sessionHooks, getUserSession, setUserSession, requireUserSession, clearUserSession, _useStoredSession } from '/Users/grandmagus/Documents/Projects/fastapi-pkgs/urauth/packages/nuxt/src/runtime/server/utils/session';